...
public class MeshCombiner : MonoBehaviour
{
	...
	public void UnpackCombinedMesh()
	{
		MeshRenderer meshRenderer = GetComponent<MeshRenderer>();
		meshRenderer.enabled = false;
		EnableAllChildrenRecursively();
	}
	
	public void EnableAllChildrenRecursively()
	{
		EnableChildrenRecursively(transform);
	}
	
	private void EnableChildrenRecursively(Transform parent)
	{
		parent.gameObject.SetActive(true);
		foreach (Transform child in parent)
		{
			EnableChildrenRecursively(child);
		}
	}
